...
import { IoIosAdd, IoIosSearch, IoMdCloseCircle } from "react-icons/io";
    ...
    <div className="mt-20 p-5 w-full h-[calc(100vh-5.5rem)] overflow-y-hidden">
      ...
      <div className="mt-2 flex gap-2 h-8">
        ...
        {person?._id ? (
          ...
          >
            ...
            <PopoverContent className="p-3 w-52 flex flex-col justify-between gap-2 shadow-xl z-10">
              ...
              <div className="flex items-end gap-1 overflow-x-scroll peoplebdy pb-1 h-14">
                {allUsers?.length ? (
        ...
        >
          ...
          <PopoverContent className="p-1 w-60 h-fit shadow-xl z-10">
            <div className="flex flex-col gap-2 overflow-y-scroll no-scrollbar">
              {selectedProject?.length ? (
                ...
                <p className="text-black m-auto text-center">No Tasks</p>
              )}
            </div>
          </PopoverContent>
        </Popover>
